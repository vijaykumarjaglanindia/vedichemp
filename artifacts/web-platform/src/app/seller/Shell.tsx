...
import {
  ...
  Target, Megaphone, MessagesSquare, BarChart3, Sparkles, Store, Wallet, Bell, Star, Users, LifeBuoy, ShieldCheck, PlugZap,
} from "lucide-react";
...
const SELLER_NAV: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/seller/connect", label: "Connect store", icon: <PlugZap {...I} /> },
    ],
  },
  {
    group: "Sell",
